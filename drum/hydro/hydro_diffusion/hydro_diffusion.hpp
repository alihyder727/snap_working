...
class HydroDiffusion {
 public:
  ...
  // mass diffusion
  void DiffusionFluxIso(const AthenaArray<Real> &prim, const AthenaArray<Real> &cons,
                      AthenaArray<Real> *flx_out);
  void DiffusionFluxAniso(const AthenaArray<Real> &prim, const AthenaArray<Real> &cons,
                        AthenaArray<Real> *flx_out);
