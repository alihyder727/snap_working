...
void Hydrogen::get_cp_(double *cp_para, double *cp_equil, double *cp_norm, double *cp_ortho, double T)
{
    double FORTH = 0.75;
    double FPARA = 0.25;
...
double Hydrogen::cp_nist(double T) {
  ...
  //if (T < 298. || T > 6000.) {
  //  msg << "ERROR: Temperature out of range in Hydrogen::cp_nist" << std::endl;
