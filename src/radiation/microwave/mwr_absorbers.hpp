...
public:
  /** Constructor for NH3 absorption (method == 1)
    ...
    */
  MwrAbsorberNH3(RadiationBand *pband, int imol, Real xHe, Real xH2O);
  /** Constructor for NH3 absorption (method == 2)
    ...
    */
  MwrAbsorberNH3(RadiationBand *pband, int imol, Real xHe, Real *xH2O, Real *pres, int np);
...
public:
  /** Constructor for PH3 absorption (method == 1)
    ...
    * @param xHe molar mixing ratio of He
    */
  MwrAbsorberPH3(RadiationBand *pband, int imol, Real xHe);
  /** Constructor for PH3 absorption (method == 2)
    ...
    */
  MwrAbsorberPH3(RadiationBand *pband, Real xHe, Real *xPH3, Real *pres, int np);
...
public:
  /** Constructor for H2O absorption (method == 1)
    ...
    * @param xHe molar mixing ratio of He
    */
  MwrAbsorberH2S(RadiationBand *pband, int imol, Real xHe);
